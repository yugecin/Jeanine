	...
	public void lineSelected(LineSelectionListener.Info info)
	{
		if (info.group == this.instr && info.panel.id.intValue() == 1) {
			...
			case 1: // append default blue colorscheme
				...
				Preferences.appendColorScheme(lines::add);
				break;
			case 2: // append default jblow colorscheme
				lines.add(new SB());
				lines.add(new SB("/*jblow colorscheme*/"));
				Colors.jblow();
				Preferences.appendColorScheme(lines::add);
				break;
			case 3: // append default jblow colorscheme
				lines.add(new SB());
				lines.add(new SB("/*jblow2024 colorscheme*/"));
				Colors.jblow2024();
				Preferences.appendColorScheme(lines::add);
				break;
			case 4: // append default handmade colorscheme
				lines.add(new SB());
				lines.add(new SB("/*handmade colorscheme*/"));
				Colors.handmade();
				Preferences.appendColorScheme(lines::add);
				break;
